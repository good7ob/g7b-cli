...
export function registerTagCommands(pmCommand: Command) {
  ...
  tagCommand
    ...
    .action(async (options) => {
      try {
        ...
        if (options.system) url = '/progress/tags/system';
        else if (options.user) url = '/progress/tags/user';
  ...
  tagCommand
    ...
    .action(async (options) => {
      try {
        ...
        const tag = await apiClient.post('/progress/tags', body);
        if (options.json) {
  ...
  tagCommand
    ...
    .action(async (id, options) => {
      try {
        ...
        await apiClient.delete(`/progress/tags/${id}`);
