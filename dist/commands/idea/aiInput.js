...
exports.withTimeoutHint = exports.buildGenerateBody = exports.GENERATE_ERROR_CODES = exports.AI_ERROR_CODES = exports.AI_TIMEOUT_MS = exports.MAX_HINTS = exports.MAX_COUNT = exports.MIN_COUNT = void 0;
const cliHelpers_1 = require("../../utils/cliHelpers");
const input_1 = require("./input");
exports.MIN_COUNT = 2;
exports.MAX_COUNT = 4;
exports.MAX_HINTS = 1000;
/** Model calls run synchronously server side; the ApiClient default (30 s) would cut them off. */
exports.AI_TIMEOUT_MS = 180000;
...
exports.GENERATE_ERROR_CODES = {
    ...input_1.IDEA_ERROR_CODES,
    ...exports.AI_ERROR_CODES,
    1007: '当前状态不允许该操作：只有 draft / evaluating 的 Idea 才能生成方案',
};
/** Only the flags that were given are sent; the backend defaults count to 3. */
function buildGenerateBody(o) {
    const body = {};
    if (o.count !== undefined)
        body.count = (0, cliHelpers_1.parseIntInRange)(o.count, '--count', exports.MIN_COUNT, exports.MAX_COUNT);
    if (o.hints !== undefined)
        body.hints = (0, cliHelpers_1.requireText)(o.hints, exports.MAX_HINTS, '--hints');
    return body;
}
exports.buildGenerateBody = buildGenerateBody;
/** The server may still finish (and bill) a call the client gave up on — warn before a blind retry. */
function withTimeoutHint(error, checkCommand) {
