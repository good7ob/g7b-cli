...
exports.registerOrgCommands = void 0;
...
function registerOrgCommands(program) {
    ...
    orgCommand
        ...
        try {
            ...
            const result = await ApiClient_1.default.get('/api/v1/orgs', params);
            ...
            console.log('─'.repeat(85));
            records.forEach((o) => {
                console.log(String(o.id).padEnd(8) +
    ...
    orgCommand
        ...
        try {
            const org = await ApiClient_1.default.get(`/api/v1/orgs/${orgId}`);
            if (options.json) {
    ...
    orgCommand
        ...
        .action(async (options) => {
        try {
            const body = { name: options.name, subscriptionTier: options.tier };
            if (options.slug)
            ...
            const org = await ApiClient_1.default.post('/api/v1/orgs', body);
            if (options.json) {
                console.log(JSON.stringify(org, null, 2));
                return;
            }
    ...
    orgCommand
        ...
        try {
            ...
            if (options.logoUrl)
                body.logoUrl = options.logoUrl;
            await ApiClient_1.default.put(`/api/v1/orgs/${orgId}`, body);
    ...
    orgCommand
        ...
        try {
            ...
            await ApiClient_1.default.delete(`/api/v1/orgs/${orgId}?force=true`);
    ...
    orgCommand
        ...
        .action(async (orgId, options) => {
        try {
            const sub = await ApiClient_1.default.get(`/api/v1/orgs/${orgId}/subscription`);
            if (options.json) {
    ...
    orgCommand
        ...
        .action(async (orgId, options) => {
        try {
            await ApiClient_1.default.post(`/api/v1/orgs/${orgId}/subscription/upgrade`, {
