...
function registerMemberCommands(orgCommand) {
    ...
    orgCommand
        ...
        try {
            ...
            console.log('─'.repeat(90));
            records.forEach((m) => {
                console.log(String(m.userId).padEnd(10) +
    ...
    orgCommand
        ...
        .action(async (orgId, options) => {
        try {
            await ApiClient_1.default.post(`/api/v1/orgs/${orgId}/members/invite`, {
                email: options.email,
                role: options.role,
            });
    ...
    orgCommand
        ...
        try {
            ...
            const body = { emails, role: options.role };
            if (options.message)
                body.message = options.message;
            const result = await ApiClient_1.default.post(`/api/v1/orgs/${orgId}/members/batch-invite`, body);
    ...
    orgCommand
        ...
        try {
            await ApiClient_1.default.put(`/api/v1/orgs/${orgId}/members/${userId}`, { role: options.role });
    ...
    orgCommand
        ...
        try {
            ...
            await ApiClient_1.default.delete(`/api/v1/orgs/${orgId}/members/${userId}`);
    ...
    orgCommand
        ...
        try {
            ...
            await ApiClient_1.default.post(`/api/v1/orgs/${orgId}/members/leave`);
...
exports.registerMemberCommands = registerMemberCommands;
