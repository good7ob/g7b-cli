...
function registerReportCommands(pmCommand) {
    ...
    reportCommand
        ...
        try {
            const reports = await ApiClient_1.default.get(`/progress/reports/project/${projectId}`);
            if (options.json) {
    ...
    reportCommand
        ...
        try {
            const report = await ApiClient_1.default.get(`/progress/reports/${id}`);
            if (options.json) {
    ...
    reportCommand
        ...
        try {
            ...
            const report = await ApiClient_1.default.post('/progress/reports/generate', { projectId: parseInt(projectId) });
    ...
    reportCommand
        ...
        try {
            ...
            await ApiClient_1.default.put(`/progress/reports/${id}`, body);
    ...
    reportCommand
        ...
        .action(async (id) => {
        try {
            await ApiClient_1.default.post(`/progress/reports/${id}/publish`);
    ...
    reportCommand
        ...
        .action(async (id) => {
        try {
            await ApiClient_1.default.post(`/progress/reports/${id}/archive`);
    ...
    reportCommand
        ...
        try {
            ...
            await ApiClient_1.default.delete(`/progress/reports/${id}`);
